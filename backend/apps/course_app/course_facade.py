...
from course_app.course_commands import ListCourseCommand, SaveCourseCommand, UpdateCourseCommand, CourseForm,\
    GetCourseCommand, DeleteCourseCommand
...
def course_form(**kwargs):
    """
    Function to get Course's detail form.
    :param kwargs: form properties
    :return: Form
    """
    return CourseForm(**kwargs)
...
def get_course_cmd(course_id):
    ...
    :return: Command
    """
    return GetCourseCommand(course_id)
...
def delete_course_cmd(course_id):
    ...
    :return: Command
    """
    return DeleteCourseCommand(course_id)
